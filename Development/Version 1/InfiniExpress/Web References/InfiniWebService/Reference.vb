...
Namespace InfiniWebService
    ...
    Public Class InfiniService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://www.accountscentre.com/ExpressWebService/Default.asmx"
        End Sub
        ...
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.accountscentre.com/GetServiceInfo", RequestNamespace:="http://www.accountscentre.com/", ResponseNamespace:="http://www.accountscentre.com/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function GetServiceInfo(ByVal CutId As Integer) As Boolean
            Dim results() As Object = Me.Invoke("GetServiceInfo", New Object() {CutId})
            Return CType(results(0),Boolean)
        End Function
        
        '<remarks/>
        Public Function BeginGetServiceInfo(ByVal CutId As Integer, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("GetServiceInfo", New Object() {CutId}, callback, asyncState)
        End Function
        
        '<remarks/>
        Public Function EndGetServiceInfo(ByVal asyncResult As System.IAsyncResult) As Boolean
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),Boolean)
        End Function
        ...
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.accountscentre.com/CreateNewVendor", RequestNamespace:="http://www.accountscentre.com/", ResponseNamespace:="http://www.accountscentre.com/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function CreateNewVendor(ByVal ds As System.Data.DataSet) As System.Data.DataSet
            Dim results() As Object = Me.Invoke("CreateNewVendor", New Object() {ds})
            Return CType(results(0),System.Data.DataSet)
        End Function
        
        '<remarks/>
        Public Function BeginCreateNewVendor(ByVal ds As System.Data.DataSet, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("CreateNewVendor", New Object() {ds}, callback, asyncState)
        End Function
        
        '<remarks/>
        Public Function EndCreateNewVendor(ByVal asyncResult As System.IAsyncResult) As System.Data.DataSet
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),System.Data.DataSet)
        End Function
        
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.accountscentre.com/CreateNewCustomer", RequestNamespace:="http://www.accountscentre.com/", ResponseNamespace:="http://www.accountscentre.com/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function CreateNewCustomer(ByVal ds As System.Data.DataSet) As System.Data.DataSet
            Dim results() As Object = Me.Invoke("CreateNewCustomer", New Object() {ds})
            Return CType(results(0),System.Data.DataSet)
        End Function
        
        '<remarks/>
        Public Function BeginCreateNewCustomer(ByVal ds As System.Data.DataSet, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("CreateNewCustomer", New Object() {ds}, callback, asyncState)
        End Function
        
        '<remarks/>
        Public Function EndCreateNewCustomer(ByVal asyncResult As System.IAsyncResult) As System.Data.DataSet
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),System.Data.DataSet)
        End Function
    End Class
