...
Public Class Customer_Creditcard_info
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Customer Creditcard info.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustomer_Creditcard_info
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Customer_Creditcard_info = New Customer_Creditcard_info
        rpt.Site = Me.Site
        Return rpt
    End Function
