...
Public Class LedgerActivityReport
    ...
    Public Overrides Property ResourceName As [String]
        Get
            Return "LedgerActivityReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLedgerActivityReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LedgerActivityReport = New LedgerActivityReport
        rpt.Site = Me.Site
        Return rpt
    End Function
