...
Public Class SalesReceiptsReport
    ...
    Public Overrides Property ResourceName As [String]
        Get
            Return "SalesReceiptsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesReceiptsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesReceiptsReport = New SalesReceiptsReport
        rpt.Site = Me.Site
        Return rpt
    End Function
